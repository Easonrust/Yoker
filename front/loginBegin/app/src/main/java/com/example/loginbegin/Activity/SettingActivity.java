...
import com.example.loginbegin.utils.*;
...
public class SettingActivity extends Activity implements View.OnClickListener{
    ...
    private void initView(){
        ...
        tv_main_title.setText("Setting");
        title_bar.setBackground(getResources().getDrawable(R.drawable.default_bg));
    ...
    @Override public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.rl_modify_psw: //修改密码界面
                ...
                break;
            case R.id.rl_security_setting: //设置密保界面
                break;
